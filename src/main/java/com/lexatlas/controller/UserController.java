...
import com.lexatlas.common.annotation.AuditLog;
...
import com.lexatlas.entity.dto.SendCodeDTO;
...
@Tag(name = "用户认证", description = "登录注册、密码找回、个人资料管理")
public class UserController {
     ...
     * 用户登录
     */
    @Operation(summary = "用户登录", description = "验证成功后返回 JWT Token")
    @PostMapping("/login")
