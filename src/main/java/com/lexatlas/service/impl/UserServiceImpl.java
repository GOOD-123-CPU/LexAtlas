...
import com.lexatlas.common.utils.JwtUtils;
import com.lexatlas.entity.SysUser;
import com.lexatlas.entity.dto.LoginDTO;
import com.lexatlas.entity.dto.RegisterDTO;
import com.lexatlas.entity.dto.UserUpdateDTO;
import com.lexatlas.entity.vo.LoginVO;
import com.lexatlas.mapper.SysUserMapper;
import com.lexatlas.entity.dto.ResetPasswordDTO;
...
public class UserServiceImpl implements UserService {
    ...
    @Value("${app.password-reset.demo-mode:false}")
    private boolean passwordResetDemoMode;
    ...
    public void sendResetCode(String phone) {
        if (!passwordResetDemoMode) {
            throw new BusinessException("密码找回服务尚未配置，请联系管理员");
        }
        // 校验手机号是否已注册
        SysUser user = sysUserMapper.selectOne(
                new LambdaQueryWrapper<SysUser>()
